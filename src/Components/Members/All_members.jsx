    ...
    <div className="max-w-[90%] mx-auto">
      ...
      <ul className="grid grid-cols-6 gap-0">
        {memberList.map((member) => (
          <li
            key={member.id}
            className="border rounded-md hover:scale-105 hover:transition-all hover:duration-1000 hover:ease-in-out h-[230px] w-[200px]"
          >
            <div className="max-w-[90%] mx-auto">
              <div className="text-center">
                ...
                <div className="bg-[gray] mt-3">
                  ...
                  <button
                    onClick={() => handleMemberDetail(member.id)}
